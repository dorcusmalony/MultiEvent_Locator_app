...
- Each event now includes a `googleMapsUrl` field that provides a link to the event's location on Google Maps.

### Real-Time Updates
- A WebSocket server broadcasts real-time updates for event changes.
